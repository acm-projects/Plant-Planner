...
public class customAdapterOld extends RecyclerView.Adapter<customAdapterOld.ViewHolder> {
    ...
    // Constructor
    public customAdapterOld(Context context, ArrayList<Plant> plantArrayList) {
    ...
    @NonNull
    @Override
    public customAdapterOld.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull customAdapterOld.ViewHolder holder, int position) {
        if(getItemViewType(position) == 2){
            ...
            Picasso.get().load(p.getPlant_image()).fit().centerInside().into(holder.plantIV);
        }
    }
